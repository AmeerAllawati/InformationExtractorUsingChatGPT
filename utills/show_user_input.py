...
from utills.text_splitter import split_text, create_knowledge_base
...
def retrieve_related_documents(knowledge_base, user_question):
    ...
    """
    if user_question:
        return knowledge_base.similarity_search(user_question)
    return []
...
def show_user_input(knowledge_base, user_question):
    """
